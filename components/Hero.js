...
export default function Hero() {
  return (
    <section id="hero" className="px-10 py-20 flex flex-col md:flex-row items-center gap-10" style={{ background: "linear-gradient(160deg, #fdf6f0, #f5eef8)" }}>

      <div className="flex-shrink-0 md:order-2">
        <Image
          src="/Photo_Fildzah.jpeg"
          alt="Fildzah Attira Khair"
          width={280}
          height={280}
          priority
          className="rounded-full object-cover"
          style={{ border: "4px solid rgba(192,132,184,0.4)" }}
        />
      </div>

      <div className="flex-1 md:order-1">
        <h1 className="text-4xl font-bold" style={{ color: "#3d2952", fontFamily: "Georgia, serif" }}>Software Development Enthusiast</h1>
