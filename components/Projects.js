export default function Projects() {
  return (
    <section id="projects" className="px-10 py-20" style={{ background: "#3d2952" }}>
      <h2 className="text-2xl mb-10" style={{ fontFamily: "Georgia, serif", color: "#f5eef8", fontWeight: 400 }}>
        <em>Projects</em>
      </h2>

      <a href="https://github.com/fildzahattira/mandiribersama?tab=readme-ov-file#about-the-app" target="_blank" className="block mb-4 rounded-lg p-6 transition hover:brightness-95" style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.12), rgba(192,132,184,0.15))", border: "1px solid rgba(192,132,184,0.25)" }}>
      ...
      <a href="https://github.com/fildzahattira/sideChef_mobileApp?tab=readme-ov-file#about-the-app" target="_blank" className="block mb-4 rounded-lg p-6 transition hover:brightness-95" style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.12), rgba(192,132,184,0.15))", border: "1px solid rgba(192,132,184,0.25)" }}>
      ...
      <a href="https://github.com/fildzahattira/Cpp-Project_Fildzah" target="_blank" className="block mb-4 rounded-lg p-6 transition hover:brightness-95" style={{ background: "linear-gradient(135deg, rgba(255,255,255,0.12), rgba(192,132,184,0.15))", border: "1px solid rgba(192,132,184,0.25)" }}>
